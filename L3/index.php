...
<table border=1px>
    ...
    <tr>
        <td>2</td>       
        <td> <a href=".\l2\house.html"> Lab 2 </a></td>
        <td>As conclusion, I had learned about the website content management
             such as managing the webpage template, table, image and font
             properties. I had also learned about the color matching for
             the website to make user feel comfortable while using the website.</td>
        </tr>
    <tr>
        <td>3</td>       
        <td> <a href=".\l3\home.html">Lab 3 </a></td>
    ...
    <tr>
        <td>4</td>        
        <td> <a href=".\l4\product.html"> Lab 4 </a></td>
    ...
    <tr>
        <td>5</td>        
        <td> <a href=".\l5\index.php"> Lab 5 </a></td>
        <td>In this lab, I had learned how to apply build page with php and html, 
            and the ways to upload file to the server.
        </td>
    </tr>
</table>
</div>
